...
uint64_t get_staking_requirement(cryptonote::network_type m_nettype, uint64_t height, int hf_version)
{
  ...
  uint64_t hardfork_height = m_nettype == cryptonote::MAINNET ? 43200 : 96210 /* stagenet */;
  ...
  {
    base     = 150000 * COIN;
    variable = (250007.0 * COIN) / kredits::exp2(height_adjusted/129600.0);
  }
  else
  {
    base      = 100000 * COIN;
    variable  = (350000.0 * COIN) / kredits::exp2(height_adjusted/129600.0);
  }
